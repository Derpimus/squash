...
btn.addEventListener('click', () => {
     ...
     const matchHistoryRow = document.querySelectorAll('.row')
     for (let i = 0; i < history.length; i++) {
          matchHistoryRow[i].addEventListener('click', () => {
               console.log('object');
               history.splice(i, 1)

               
               //******************************rysowanie w tabeli dolnej */
               for (let i = 0; i < history.length; i++) {
                    matchHistory.innerHTML += `
                    <div class="row" id=Row${i}>
                         <span class="name1">${history[i][0]}</span>
...
>>>>>>> f89e703ec1d0f5bcff809e85b3fadfeb3704b489
})